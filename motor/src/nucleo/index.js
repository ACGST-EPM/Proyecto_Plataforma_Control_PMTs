...
export { CONFIG_POR_DEFECTO, PERFIL_LEGADO, resolverConfig, alcanceMetros, describirModeloEspacial,
  VERSION_REGLAS, REGLAS_CANONICAS } from './config.js';
export { zonaDeInfluencia, zonasSeSuperponen, solapeMetros, RADIO_INFLUENCIA_METROS } from '../geo/zona-influencia.js';
